...
public class MorseCodeMain extends BorderPane {
	...
	convertString.setOnAction(event -> {
	    try {
    ...
    /**
     * Allow the user to select a file of morse code and then display the contents
     * of the file, as well as the conversion of the file into English
     */
